...
//    String s_captureSavePath = "G:\\JYGS\\downloadVideo//Capture//" + ToolKits.getDay() + "/"; // 抓拍图片保存路径
//    String s_imageSavePath = "G:\\JYGS\\downloadVideo//Image//" + ToolKits.getDay() + "/"; // 图片保存路径
//    String s_recordFileSavePath = "G:\\JYGS\\downloadVideo//RecordFile//" + ToolKits.getDay() + "/"; // 录像保存路径
